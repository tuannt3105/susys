...
export class ItemDateTimeFromTo extends Component {
    ...
    _showDateTimeFromPicker = () => {
        this.props.onDateTimeFromSelected(this.props.dateFrom);
        this.setState({ dateTimeFrom: this.props.dateFrom });
        this.setState({ isVisibleFrom: true });
    }

    _showDateTimeToPicker = () => {
        this.props.onDateTimeToSelected(this.props.dateTo);
        this.setState({ dateTimeTo: this.props.dateTo });
        this.setState({ isVisibleTo: true });
    }
